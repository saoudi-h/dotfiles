...
keymap.set("n", "<Leader>o", "o<Esc>^Da", { desc = "New line below without indent" })
keymap.set("n", "<Leader>O", "O<Esc>^Da", { desc = "New line above without indent" })
...
keymap.set("n", "<Leader>9", "<Cmd>BufferLineGoToBuffer -1<CR>", { desc = "Go to last buffer" })
